...
func (r *requestImpl) Header() lava.RequestHeader {
	return httputil.WrapRequestHeader(&r.req.req.Header)
}
...
func (r *responseImpl) Header() lava.ResponseHeader {
	return httputil.WrapResponseHeader(&r.resp.Header)
}
