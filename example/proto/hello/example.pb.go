...
func init() {
	...
	golang_proto.RegisterEnum("hello.Role", Role_name, Role_value)
	proto.RegisterType((*User)(nil), "hello.User")
	golang_proto.RegisterType((*User)(nil), "hello.User")
	proto.RegisterType((*UserRole)(nil), "hello.UserRole")
	golang_proto.RegisterType((*UserRole)(nil), "hello.UserRole")
	proto.RegisterType((*UpdateUserRequest)(nil), "hello.UpdateUserRequest")
	golang_proto.RegisterType((*UpdateUserRequest)(nil), "hello.UpdateUserRequest")
	proto.RegisterType((*ListUsersRequest)(nil), "hello.ListUsersRequest")
	golang_proto.RegisterType((*ListUsersRequest)(nil), "hello.ListUsersRequest")
}

func init() { proto.RegisterFile("example/proto/hello/example.proto", fileDescriptor_b5e40adf3dad5b91) }
func init() {
	golang_proto.RegisterFile("example/proto/hello/example.proto", fileDescriptor_b5e40adf3dad5b91)
}
...
var fileDescriptor_b5e40adf3dad5b91 = []byte{
	...
	,
}
