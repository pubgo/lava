...
func RegisterBindTelephoneServer(s grpc.ServiceRegistrar, srv BindTelephoneServer) {
	s.RegisterService(&BindTelephone_ServiceDesc, srv)
}
...
// BindTelephone_ServiceDesc is the grpc.ServiceDesc for BindTelephone service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var BindTelephone_ServiceDesc = grpc.ServiceDesc{
