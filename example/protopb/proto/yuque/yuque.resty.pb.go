...
type YuqueResty interface {
	...
	// 获取单个用户信息
	UserInfoById(ctx context.Context, in *UserInfoReq, opts ...func(req *v2.Request)) (*UserInfoResp, error)
	// 创建 Group
...
func (c *yuqueResty) UserInfoById(ctx context.Context, in *UserInfoReq, opts ...func(req *v2.Request)) (*UserInfoResp, error) {
	var req = c.client.R()
	if ctx != nil {
		req.SetContext(ctx)
	}
	...
	var resp, err = req.Execute("GET", "/users/{id}")
	if err != nil {
		return nil, err
	}
	out := new(UserInfoResp)
