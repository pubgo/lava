...
type userResty struct {
	client *v2.Client
}

func (c *userResty) Generate(ctx context.Context, in *GenerateRequest, opts ...func(req *v2.Request)) (*GenerateResponse, error) {
	var req = c.client.R()
	if ctx != nil {
		req.SetContext(ctx)
	}
...
func (c *userResty) Types(ctx context.Context, in *TypesRequest, opts ...func(req *v2.Request)) (*TypesResponse, error) {
	var req = c.client.R()
	if ctx != nil {
		req.SetContext(ctx)
	}
