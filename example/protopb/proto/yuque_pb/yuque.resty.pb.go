...
type UserServiceResty interface {
	// user signin
	Signin(ctx context.Context, in *UserInfoReq, opts ...func(req *v2.Request)) (*UserInfoResp, error)
	// user resets password
	ResetPassword(ctx context.Context, in *UserInfoReq, opts ...func(req *v2.Request)) (*emptypb.Empty, error)
}
...
func (c *userServiceResty) Signin(ctx context.Context, in *UserInfoReq, opts ...func(req *v2.Request)) (*UserInfoResp, error) {
	var req = c.client.R()
	if ctx != nil {
		req.SetContext(ctx)
	}
	...
	req.SetBody(body)
	var resp, err = req.Execute("POST", "/api/v1/users/signin")
	if err != nil {
		return nil, err
	}
	out := new(UserInfoResp)
...
func (c *userServiceResty) ResetPassword(ctx context.Context, in *UserInfoReq, opts ...func(req *v2.Request)) (*emptypb.Empty, error) {
	var req = c.client.R()
	if ctx != nil {
		req.SetContext(ctx)
	}
	...
	req.SetBody(body)
	var resp, err = req.Execute("POST", "/api/v1/users/reset_password")
	if err != nil {
		return nil, err
	}
