...
func RegisterMenuServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MenuServiceServer) error {
	...
	mux.Handle("POST", pattern_MenuService_ListMenus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/perm.v1.MenuService/ListMenus", runtime.WithHTTPPathPattern("/perm.v1.MenuService/ListMenus"))
		if err != nil {
...
func RegisterMenuServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MenuServiceClient) error {
	...
	mux.Handle("POST", pattern_MenuService_ListMenus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/perm.v1.MenuService/ListMenus", runtime.WithHTTPPathPattern("/perm.v1.MenuService/ListMenus"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_MenuService_ListMenus_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"perm.v1.MenuService", "ListMenus"}, ""))
)
