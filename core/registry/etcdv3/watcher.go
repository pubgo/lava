...
func newWatcher(r *Registry, timeout time.Duration, opts ...registry_type2.WatchOpt) (registry_type2.Watcher, error) {
...
func (w *Watcher) Next() (*registry_type2.Result, error) {
	for resp := range w.w {
		if resp.Err() != nil {
			return nil, resp.Err()
		}
