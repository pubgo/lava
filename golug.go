...
func Start(ent golug_entry.Entry) error              { return golug_app.Start(ent) }
func Stop(ent golug_entry.Entry) error               { return golug_app.Stop(ent) }
func Run(entries ...golug_entry.Entry) (err error)   { return golug_app.Run(entries...) }
