...
func newEntry(name string) *Entry {
	...
	return &Entry{opts: server.Opts{
		Name:    name,
		Command: &cli.Command{Name: name},
	}}
}

var _ server.Entry = (*Entry)(nil)
var _ server.Runtime = (*Entry)(nil)
...
func (t *Entry) RegisterHandler(h server.Handler) { t.opts.Handlers = append(t.opts.Handlers, h) }
...
func (t *Entry) Options() server.Opts {
	var opts = t.opts
