...
import (
	...
	"github.com/pubgo/lava/server/base"
	"github.com/pubgo/lava/server/grpcEntry/grpc-gw"
	"github.com/pubgo/lava/server/grpcEntry/grpcs"
	"github.com/pubgo/lava/types"
	"github.com/pubgo/lava/version"
)

func New(name string) Service { return newEntry(name) }
...
func (t *grpcEntry) Flags(flag cli.Flag) {
	if flag == nil {
		return
	}
...
func (t *grpcEntry) Commands(cmd *cli.Command) {
	if cmd == nil {
		return
	}
...
func (t *grpcEntry) Description(description ...string) {
...
func (g *grpcEntry) RegisterMatcher(priority int64, matches ...func(io.Reader) bool) func() net.Listener {
	//TODO implement me
	panic("implement me")
}

func (g *grpcEntry) InnerGrpcClientConn() grpc.ClientConnInterface {
	//TODO implement me
	panic("implement me")
}

func (g *grpcEntry) ServiceDesc() ServiceDesc {
	//TODO implement me
	panic("implement me")
}

func (g *grpcEntry) Plugin(plugin plugin.Plugin) {
	//TODO implement me
	panic("implement me")
}

func (g *grpcEntry) Options() Options {
	//TODO implement me
	panic("implement me")
}
...
func (g *grpcEntry) Register(handler server.Handler) {
	defer xerror.RespExit()
