...
const (
	SrvErrCode_OK SrvErrCode = 0
	// id generate error
	SrvErrCode_IDGenerateFailed SrvErrCode = 1
)

// Enum value maps for SrvErrCode.
var (
	SrvErrCode_name = map[int32]string{
		0: "OK",
		1: "IDGenerateFailed",
	}
	SrvErrCode_value = map[string]int32{
		"OK":               0,
		"IDGenerateFailed": 1,
	}
)

func (x SrvErrCode) Enum() *SrvErrCode {
	p := new(SrvErrCode)
	*p = x
	return p
}

func (x SrvErrCode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SrvErrCode) Descriptor() protoreflect.EnumDescriptor {
	return file_gid_id_proto_enumTypes[0].Descriptor()
}

func (SrvErrCode) Type() protoreflect.EnumType {
	return &file_gid_id_proto_enumTypes[0]
}

func (x SrvErrCode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SrvErrCode.Descriptor instead.
func (SrvErrCode) EnumDescriptor() ([]byte, []int) {
...
var file_gid_id_proto_rawDesc = []byte{
	...
	0x69, 0x65, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x63, 0x2d, 0x67, 0x65, 0x6e, 0x2d, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x76, 0x32,
	0x2f, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x61, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x14, 0x65, 0x72, 0x72, 0x6f,
	...
	0x74, 0x79, 0x70, 0x65, 0x73, 0x2a, 0x3a, 0x0a, 0x0a, 0x53, 0x72, 0x76, 0x45, 0x72, 0x72, 0x43,
	...
	0x01, 0x1a, 0x06, 0x92, 0xea, 0x30, 0x02, 0x10, 0x0d, 0x1a, 0x06, 0x8a, 0xea, 0x30, 0x02, 0x08,
	...
	0x30, 0x42, 0x85, 0x04, 0x5a, 0x0d, 0x2e, 0x2f, 0x67, 0x69, 0x64, 0x70, 0x62, 0x3b, 0x67, 0x69,
	0x64, 0x70, 0x62, 0x92, 0x41, 0xf2, 0x03, 0x12, 0xf6, 0x01, 0x0a, 0x13, 0x41, 0x20, 0x42, 0x69,
...
var file_gid_id_proto_depIdxs = []int32{
	...
	4, // 1: gid.Id.Types:input_type -> gid.TypesRequest
	2, // 2: gid.Id.Generate:output_type -> gid.GenerateResponse
	5, // 3: gid.Id.Types:output_type -> gid.TypesResponse
