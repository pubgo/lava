...
var file_gid_id_proto_rawDesc = []byte{
	...
	0x0a, 0x07, 0x73, 0x68, 0x6f, 0x72, 0x74, 0x69, 0x64, 0x10, 0x04, 0x32, 0xb3, 0x03, 0x0a, 0x02,
	...
	0x08, 0x2f, 0x77, 0x73, 0x2f, 0x63, 0x68, 0x61, 0x74, 0x28, 0x01, 0x30, 0x01, 0x12, 0x5f, 0x0a,
	...
	0x6c, 0x65, 0x73, 0x2f, 0x7b, 0x66, 0x69, 0x6c, 0x65, 0x6e, 0x61, 0x6d, 0x65, 0x7d, 0x1a, 0x11,
...
var file_gid_id_proto_depIdxs = []int32{
	...
	3, // 6: gid.Id.UploadDownload:input_type -> gid.UploadFileRequest
	2, // 7: gid.Id.Generate:output_type -> gid.GenerateResponse
	7, // 8: gid.Id.TypeStream:output_type -> gid.TypesResponse
	7, // 9: gid.Id.Types:output_type -> gid.TypesResponse
	4, // 10: gid.Id.Chat:output_type -> gid.ChatMessage
	8, // 11: gid.Id.UploadDownload:output_type -> google.api.HttpBody
