...
var file_gid_id_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x33, 0x0a, 0x0f, 0x47, 0x65, 0x6e, 0x65,
	...
	0x47, 0x65, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x0e, 0x0a,
	...
	0x73, 0x68, 0x6f, 0x72, 0x74, 0x69, 0x64, 0x10, 0x04, 0x32, 0x80, 0x02, 0x0a, 0x02, 0x49, 0x64,
	...
	0x74, 0x65, 0x3a, 0x01, 0x2a, 0x12, 0x4c, 0x0a, 0x0a, 0x54, 0x79, 0x70, 0x65, 0x53, 0x74, 0x72,
	...
	0x31, 0x30, 0x01, 0x12, 0x44, 0x0a, 0x05, 0x54, 0x79, 0x70, 0x65, 0x73, 0x12, 0x11, 0x2e, 0x67,
...
var file_gid_id_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_gid_id_proto_depIdxs = []int32{
	...
	3, // 1: gid.Id.Generate:input_type -> gid.GenerateRequest
	4, // 2: gid.Id.TypeStream:input_type -> gid.TypesRequest
	4, // 3: gid.Id.Types:input_type -> gid.TypesRequest
	2, // 4: gid.Id.Generate:output_type -> gid.GenerateResponse
	5, // 5: gid.Id.TypeStream:output_type -> gid.TypesResponse
	5, // 6: gid.Id.Types:output_type -> gid.TypesResponse
