...
var _ abc.Request = (*rpcRequest)(nil)
...
func (r *rpcRequest) Header() *abc.RequestHeader { return r.header }
...
var _ abc.Request = (*httpRequest)(nil)
...
func (r *httpRequest) Header() *abc.RequestHeader { return &r.ctx.Request().Header }
