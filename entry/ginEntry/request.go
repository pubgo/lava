...
func (r *httpRequest) Header() types.Header  { return r.ctx.Request.Header }
func (r *httpRequest) Payload() interface{}  { return nil }
func (r *httpRequest) Body() ([]byte, error) { panic("implement me") }
...
func (r *httpRequest) Codec() string         { return encoding.Mapping[r.ContentType()] }
